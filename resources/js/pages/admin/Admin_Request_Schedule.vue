                            ...
                            <td class="action-cell">
                                <div class="table_action">
                                    ...
                                    <Button icon="pi pi-trash" raised severity="danger"
                                        ...
                                        @click="deleteBtn(data.schedule_id)" class="action-btn" />
                                    <Button label="Approve" severity="success" icon="pi pi-check" raised
                                        @click="approve(data)" v-if="data.status === 'pending'"
                                        class="action-btn" />
                                    <Message severity="error" v-if="data.status === 'not-release'" class="status-message">Not approve</Message>
                                    <Message v-if="data.status === 'released'" class="status-message">Approved</Message>
                                </div>
                            </td>
                        </tr>
                    </tbody>
