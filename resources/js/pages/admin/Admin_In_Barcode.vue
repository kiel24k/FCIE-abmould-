                            ...
                            <div class="name">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="li_info">
                                            <span>₱{{
                                                barcodeData[0].unit_cost.toString().replace(/\B(?=(\d{3})+(?!\d))/g,
                                                    ',')
                                                }}</span>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="li_info">
                                            <span>₱{{
                                                barcodeData[0].total_cost.toString().replace(/\B(?=(\d{3})+(?!\d))/g,
                                                    ',')
                                                }}.00</span>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="list_action">
                                            <span class="text-danger" v-if="validation.quantity">{{
                                                validation.quantity[0] }}
                                            </span>
                                            <div class="list_field">
                                                <div class="field">
                                                    <InputNumber v-model="quantity" showButtons
                                                        buttonLayout="horizontal" style="width: 3rem" :min="1">
                                                ...
                                                <div class="list_submit">
                                                    <Button label="Increase / In" severity="info" raised
                                                        @click="submit()" />
                                                </div>
                                            </div>
                                        </div>
